    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <h3>Black Full Sleeve Tshirt</h3>
                <h4>M,L,XL</h4>
                <p>NRS 1250</p>
            ...
            <div class="col-4">
                <img src="{{ asset('assets/image/product7.jpg') }}">
                <h3>Grey Full Sleeve Tshirt</h3>
                <h4>M,L,XL</h4>
                <p>NRS 1250</p>
            </div>
            <div class="col-4">
                <img src="{{ asset('assets/image/product8.jpg') }}">
                <h3>Beige Full Sleeve Tshirt</h3>
                <h4>M,L,XL</h4>
                <p>NRS 1250</p>
            </div>
            <div class="col-4">
                <img src="{{ asset('assets/image/product9.jpg') }}">
                <h3>Black Crop Tshirt</h3>
                <h4>M,L,XL</h4>
                <p>NRS 1000</p>
            </div>
            <div class="col-4">
                <img src="{{ asset('assets/image/product10.jpg') }}">
                <h3>White Crop Tshirt</h3>
                <h4>M,L,XL</h4>
                <p>NRS 950</p>
            </div>
            <div class="col-4">
            ...
            <div class="col-4">
                <img src="{{ asset('assets/image/product11.jpg') }}">
                <h3>Beige Crop Tshirt</h3>
                <h4>M,L,XL</h4>
                <p>NRS 950</p>
            </div>
        </div>
